-- Babyhamsta's dex bypasses (probably could lower performance but I do not care) :thumbsup:
...
local function main()
    ...
    local nilNode = {Obj = cloneref(Instance.new("Folder"))}
    local idCounter = 0
    ...
    Explorer.StartDrag = function(offX,offY)
        ...
        local newGui = cloneref(Instance.new("ScreenGui"))
    ...
    Explorer.InitRightClick = function()
        ...
        context:Register("GROUP",{Name = "Group", IconMap = Explorer.MiscIcons, Icon = "Group", DisabledIcon = "Group_Disabled", Shortcut = "Ctrl+G", OnClick = function()
            ...
            local model = cloneref(Instance.new("Model",sList[#sList].Obj.Parent))
            for i = 1,#sList do
    ...
    Explorer.HideNilInstances = function()
        ...
        local disconnectCon = cloneref(Instance.new("Folder")).ChildAdded:Connect(function() end).Disconnect
    ...
    Explorer.InitInsertObject = function()
        ...
        local function onClick(className)
            local sList = selection.List
            local instNew = cloneref(Instance.new)
            for i = 1,#sList do
                local node = sList[i]
                local obj = node.Obj
                Explorer.MakeNodeVisible(node,true)
...
return search]==]
    ...
    Explorer.UpdateSelectionVisuals = function()
        ...
        local clone = game.Clone
        if not holder then
            holder = cloneref(Instance.new("ScreenGui"))
            ...
            local boxTemplate = cloneref(Instance.new("SelectionBox"))
...
local function main()
    ...
    Properties.SetSoundPreview = function(soundObj,noplay)
        local sound = Properties.PreviewSound
        if not sound then
            sound = cloneref(Instance.new("Sound"))
            sound.Name = "Preview"
...
local function main()
    ...
    ScriptViewer.Init = function()
        ...
        local copy = cloneref(Instance.new("TextButton",window.GuiElems.Content))
        ...
        local save = cloneref(Instance.new("TextButton",window.GuiElems.Content))
...
local function main()
    ...
    Lib.IconMap = (function()
        ...
        funcs.GetLabel = function(self)
            local label = cloneref(Instance.new("ImageLabel"))
    ...
    Lib.Window = (function()
        ...
        static.Init = function()
            ...
            sidesGui = cloneref(Instance.new("ScreenGui"))
            ...
            alignIndicator = cloneref(Instance.new("ScreenGui"))
            alignIndicator.DisplayOrder = Main.DisplayOrders.Core
            local indicator = cloneref(Instance.new("Frame",alignIndicator))
            indicator.BackgroundColor3 = Color3.fromRGB(0, 170, 255)
            indicator.BorderSizePixel = 0
            indicator.BackgroundTransparency = 0.8
            indicator.Name = "Indicator"
            local corner = cloneref(Instance.new("UICorner",indicator))
    ...
    Lib.CodeFrame = (function()
        ...
        local function makeFrame(obj)
            ...
            local linesFrame = cloneref(Instance.new("Frame"))
            ...
            local lineNumbersLabel = cloneref(Instance.new("TextLabel"))
            ...
            local cursor = cloneref(Instance.new("Frame"))
            cursor.Name = "Cursor"
            cursor.BackgroundColor3 = Color3.fromRGB(220,220,220)
            cursor.BorderSizePixel = 0
            cursor.Parent = frame
            
            local editBox = cloneref(Instance.new("TextBox"))
        ...
        funcs.Refresh = function(self)
            ...
            for row = 1,maxLines do
                ...
                if not lineFrame then
                    lineFrame = cloneref(Instance.new("Frame"))
                    lineFrame.Name = "Line"
                    ...
                    local selectionHighlight = cloneref(Instance.new("Frame"))
    ...
    Lib.ColorPicker = (function() -- TODO: Convert to newer class model
        ...
        local function new()
            ...
            local colorChoice = cloneref(Instance.new("TextButton"))
    ...
    Lib.NumberSequenceEditor = (function()
        local function new() -- TODO: Convert to newer class model
            ...
            for i = 2,10 do
                local newLine = cloneref(Instance.new("Frame"))
            ...
            local envelopeDrag = cloneref(Instance.new("Frame"))
            ...
            local envelopeDragLine = cloneref(Instance.new("Frame",envelopeDrag))
            ...
            local function placePoint(point)
                local newPoint = cloneref(Instance.new("Frame"))
                newPoint.Name = "Point"
                ...
                local newSelect = cloneref(Instance.new("Frame"))
    ...
    Lib.ViewportTextBox = (function()
        ...
        local function convert(textbox)
            ...
            local view = cloneref(Instance.new("Frame"))
    ...
    Lib.Frame = (function()
        ...
        local function new()
            local fr = cloneref(Instance.new("Frame"))
    ...
    Lib.Button = (function()
        ...
        local function new()
            local b = cloneref(Instance.new("TextButton"))
    ...
    Lib.DropDown = (function()
        ...
        local function new()
            local f = cloneref(Instance.new("TextButton"))
...
local create = function(data)
    local insts = {}
    for i,v in pairs(data) do insts[v[1]] = cloneref(Instance.new(v[2])) end
...
Main = (function()
    ...
    Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
        local gui = create({
            ...
            {5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,25),Size=UDim2.new(0,100,0,50),Text="Hardened Awesome Explorer",TextColor3=Color3.new(1,1,1),TextSize=25,TextTransparency=1,}},
            ...
            {11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Developed by Light Devs (slightly modded by voiidly)",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
            {12,"UIGradient",{Parent={11},Transparency=NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(1,1,0),}),}},
            {13,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Version",Parent={2},Position=UDim2.new(1,-110,1,-35),Size=UDim2.new(0,105,0,20),Text="Beta 6.3.0 Hardened (by a retard)",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
        ...
        local function tweenNumber(n,ti,func)
            local tweenVal = cloneref(Instance.new("IntValue"))
            tweenVal.Value = 0
